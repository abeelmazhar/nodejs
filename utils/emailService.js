                  ...
                  <tr>
                    <td style="padding: 40px 30px;">
                      ...
                      <div style="text-align: center; margin: 35px 0;">
                        <a href="${resetUrl}" style="display: inline-block; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 12px rgba(245, 87, 108, 0.3);">
                          Reset My Password
                        </a>
                      </div>
                      
                      <!-- Alternative Token Method -->
                      <div style="background-color: #f7fafc; border-radius: 8px; padding: 20px; margin: 25px 0; border-left: 4px solid #f5576c;">
                        <p style="margin: 0 0 10px 0; color: #4a5568; font-size: 14px; font-weight: 600;">
                          Or use this token manually:
                        </p>
                        <div style="background-color: #ffffff; border-radius: 6px; padding: 15px; margin-top: 10px;">
                          <code style="color: #f5576c; font-size: 13px; font-family: 'Courier New', monospace; word-break: break-all;">
                            ${resetToken}
                          </code>
                        </div>
                      </div>
                      ...
                      <div style="background-color: #fff5e6; border-left: 4px solid #ffa726; border-radius: 6px; padding: 15px 20px; margin: 25px 0;">
                        <p style="margin: 0; color: #e65100; font-size: 14px; line-height: 1.5;">
                          <strong>⏰ Important:</strong> This link will expire in <strong>15 minutes</strong>. For security reasons, please reset your password immediately.
                        </p>
                      </div>
